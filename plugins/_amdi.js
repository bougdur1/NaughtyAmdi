...
if (Config.WORKTYPE == 'private') {
    ...
    Amdi.applyCMD({pattern: 'kit ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            await message.client.sendMessage(
                message.jid,'🔞💃🏻 ●NAUGHTY AMDI PANEL● 💃🏻🔞\n\n' + CMD_HELP, MessageType.text,{quoted: message.data}
            );    
        } else {
    ...
    Amdi.applyCMD({pattern: 'kit ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
